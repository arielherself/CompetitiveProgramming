...
void solve() {
    ...
    if (m > 3) {
        ...
        for (int i = 0; i < n; ++i) {
            int up = (a[0][i] + a[1][i]) % 2;
            int down = (a[1][i] + a[2][i]) % 2;
            if (up == 1 and down == 1) {
                dp[i + 1][0b00] = dp[i][0b11] + 1;
                dp[i + 1][0b01] = dp[i][0b10] + 1;
                dp[i + 1][0b10] = dp[i][0b01] + 1;
                dp[i + 1][0b11] = dp[i][0b00];
            } else if (up == 0 and down == 1) {
                dp[i + 1][0b00] = dp[i][0b11] + 1;
                dp[i + 1][0b01] = dp[i][0b10];
                dp[i + 1][0b10] = dp[i][0b01] + 1;
                dp[i + 1][0b11] = dp[i][0b00] + 1;
