...
struct Info {
    ll ans = 0, l = 0, r = 0, lr = 0;
    void apply(const Tag& rhs, size_t len) { }
};
Info operator+(const Info &a, const Info &b) {
    return {
        .ans = max(a.r + b.ans, a.ans + b.l),
        .l   = max(a.lr + b.ans, a.l + b.l),
        .r   = max(a.ans + b.lr, a.r + b.r),
        .lr  = max(a.l + b.lr, a.lr + b.r),
    };
}
...
void solve() {
    ...
    while (q--) {
        ...
        cout << 2 * (sum - tr.range_query(0, n).lr) << '\n';
    }
}
