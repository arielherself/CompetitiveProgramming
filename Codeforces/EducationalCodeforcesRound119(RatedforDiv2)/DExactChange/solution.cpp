...
void solve() {
    ...
    for (int i = 0; i < 3; ++i) {
        for (int j = 0; j < 3; ++j) {
            int curr = 0, f = 1;
            for (auto&& x : a) {
                if (i >= 2 && j >= 2 && x >= 6 && (x - 6) % 3 == 0) {
                    curr = max(curr, (x - 6) / 3);
                } else if (i >= 1 && j >= 2 && x >= 5 && (x - 5) % 3 == 0) {
                    curr = max(curr, (x - 5) / 3);
                } else if ((i >= 2 && j >= 1 || j >= 2) && x >= 4 && (x - 4) % 3 == 0) {
                    curr = max(curr, (x - 4) / 3);
                } else if (i >= 1 && j >= 1 && x >= 3 && (x - 3) % 3 == 0) {
                    curr = max(curr, (x - 3) / 3);
                } else if ((j >= 1 || i >= 2) && x >= 2 && (x - 2) % 3 == 0) {
                    curr = max(curr, (x - 2) / 3);
                } else if (i >= 1 && x >= 1 && (x - 1) % 3 == 0) {
                    curr = max(curr, (x - 1) / 3);
                } else if (x % 3 == 0) {
                    curr = max(curr, x / 3);
                } else {
