...
private:
    ...
    void push(size_type p) {
        cerr << "b[" << p << "].val = " << b[p].val << endl;
        cerr << "pushing " << p << ": ";
        d[p * 2].apply(b[p]), d[p * 2 + 1].apply(b[p]);
        b[p * 2].apply(b[p]), b[p * 2 + 1].apply(b[p]);
        b[p] = tag_type();
        cerr << "d[" << p * 2 << "] = " << d[p * 2].val << ", ";
        cerr << "d[" << p * 2 + 1 << "] = " << d[p * 2 + 1].val << "\n";
    }
    ...
    void range_apply(size_type s, size_type t, size_type p, size_type l, size_type r, const tag_type& c) {
        cerr << "enter range_apply(" << s << ", " << t << ", " << p << ", " << l << ", " << r << ")" << endl;
        if (l <= s && t <= r) {
            d[p].apply(c);
            b[p].apply(c);
        cerr << "b[" << p << "].val = " << b[p].val << endl;
        ...
        d[p] = d[p * 2] + d[p * 2 + 1];
        cerr << "exit range_apply(" << s << ", " << t << ", " << p << ", " << l << ", " << r << ")" << endl;
    }
...
void solve() {
    segtree<Set_Info, Set_Tag> tr({{ 10 }, { 9 }, { 5 }, { 2 }, { 2 }, { 0 }});
    tr.range_apply(0, 2, {5});
